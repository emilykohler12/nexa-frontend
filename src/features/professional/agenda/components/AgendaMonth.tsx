...
export function AgendaMonth({ appointments, month, primary, onEventClick }: Props) {
  ...
  const isToday = (day: number) =>
    day === today.getDate() && month.getMonth() === today.getMonth() && month.getFullYear() === today.getFullYear()
              ...
              {day !== null && (
                <>
                  ...
                  {getAppts(day).length > 3 && (
                    <div style={{ fontSize: '11px', color: primary, fontWeight: 600, padding: '1px 4px' }}>
