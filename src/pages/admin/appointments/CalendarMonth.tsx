                ...
                <>
                  ...
                  {getAppts(day).slice(0, 3).map(a => (
                    <button key={a.id} onClick={() => onEventClick(a)} title={`${a.clientName} — ${a.serviceName}`}
                      style={{ display: 'flex', alignItems: 'center', gap: '5px', width: '100%', border: 'none', borderRadius: '4px', padding: '3px 6px', marginBottom: '2px', background: `${colorFor(a)}15`, cursor: 'pointer', textAlign: 'left', fontFamily: "'Lato', sans-serif" }}
                    >
