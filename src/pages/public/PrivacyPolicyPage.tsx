  ...
  return (
    <LegalDocumentPage title="Política de Privacidad">
      <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
        ...
        <section>
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: '#000', marginBottom: '12px' }}>7. Cookies</h2>
          <p>Ver <a href="/terminos-condiciones" style={{ color: '#069494' }}>Términos y Condiciones</a>.</p>
        </section>

        <section>
          <h2 style={{ fontSize: '20px', fontWeight: 700, color: '#000', marginBottom: '12px', borderTop: '1px solid #eee', paddingTop: '24px' }}>8. Derechos ARCO</h2>
        ...
        <section>
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: '#000', marginBottom: '12px' }}>8.1 Derecho de Acceso</h2>
        ...
        <section>
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: '#000', marginBottom: '12px' }}>8.2 Derecho de Rectificación</h2>
        ...
        <section>
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: '#000', marginBottom: '12px' }}>8.3 Derecho de Cancelación (Derecho al Olvido)</h2>
        ...
        <section>
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: '#000', marginBottom: '12px' }}>8.4 Derecho de Oposición</h2>
        ...
        <section>
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: '#000', marginBottom: '12px' }}>8.5 Procedimiento y Plazos</h2>
          <ul style={{ marginLeft: '20px' }}>
        ...
        <section>
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: '#000', marginBottom: '12px' }}>8.6 Verificación de Identidad</h2>
        ...
        <section>
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: '#000', marginBottom: '12px' }}>8.7 Recurso ante Autoridad</h2>
        ...
        <section>
          <h2 style={{ fontSize: '18px', fontWeight: 700, color: '#000', marginBottom: '12px' }}>8.8 Sin Costo</h2>
